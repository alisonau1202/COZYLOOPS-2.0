		...
		saveOrderChanges(orderId) {
			...
			fetch('purchase_api.php', {
				...
				.then(() => {
					this.editingOrder = null;
					this.loadPurchases();
					this.showInfoMessage('Success', 'Order updated successfully!'); // Using custom message
				})
				.catch(err => {
					console.error('Failed to update order:', err);
					this.showInfoMessage('Error', 'Failed to update order. Please try again.'); // Using custom message
				});
		},
				...
				() => {
					fetch('purchase_api.php', {
						...
						.then(() => {
							...
							this.showInfoMessage('Success', 'Order cancelled successfully.'); // Using custom message
						})
						.catch(err => {
							console.error('Failed to cancel order:', err);
							this.showInfoMessage('Error', 'Failed to cancel order. Please try again.'); // Using custom message
						});
				}
			);
		},
